...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    province = models.CharField(max_length=20, null=True, blank=True,verbose_name='استان')
    ...
    student_code = models.CharField(max_length=13, null=True, blank=True, unique=True,verbose_name='شماره دانشجویی')
